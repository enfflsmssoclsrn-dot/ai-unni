...
13. **호감도 올리는 길 (lift_advice, 3~4개)** — 현재 점수에서 +N점 올리는 구체적 행동 가이드
  - 각 항목은 **"+N점 · 액션 제목 — 구체적 방법"** 형식
  - 즉시 (+5~7) / 단기 (+10~15, 1주일 내) / 장기 (+15~20, 1개월 꾸준히) 3가지 시간 축으로 나눠서 제안
  - **사용자가 통제 가능한 행동만** (상대 마음 바꾸기 X, "내가 무엇을 다르게 해야" 관점)
  - 분석 결과 약점 축 (axes 점수 낮은 것)을 보강하는 액션이 우선
  - 마지막 1~2개 항목은 ~다냥 끝
  - 예시:
    · "+5점 · 답장 텀 조절 — 30분 안에 답하지 말고 1~2시간 텀 두기. 여유 있는 사람이 더 매력 있다냥."
    · "+10점 · 너의 일상 먼저 던지기 — '오늘 카페에서 ~' 식 짧은 스토리부터. 상대도 자기 얘기 꺼내기 시작해."
    · "+15점 · 다음 약속 구체적으로 — '담주 토요일 7시 ~ 어때?' 식 명확한 제안. 막연한 '언제 한번' X."

JSON만 응답해:
{"score":72,"temperature":"따뜻","stage":"썸","summary":"촌철살인","axes":{"관심도":85,"적극성":62,"반응성":78,"친밀감":54,"일관성":70,"미래지향":45},"attachment":{"avoidance":55,"anxiety":40,"type":"회피형","comment":"거리두기는 있지만 완전 끊진 않음"},"red_flags":{"criticism":15,"defensiveness":20,"contempt":10,"stonewalling":25},"diagnosis":"진단","reasons":["1","2","3"],"warnings":["1","2"],"psychology":"심리","actions":["1","2","3","4"],"lift_advice":["+5점 · 즉시 액션 — 구체 방법","+10점 · 단기 액션 — 구체 방법","+15점 · 장기 액션 — 구체 방법"]}`;
