...
3. 추측 금지. 이미지·분석 결과에 실제로 나타난 패턴만 반영.
...

{
  ...
  "emotional_triggers": {
    "likes": "이 말투/주제에 호의적 반응 보임 (예: '칭찬받으면 수줍게 부정', '맛집 얘기 관심 많음')",
    "dislikes": "짜증/회피 트리거 (예: '추궁당하면 말 짧아짐', '감정 캐물으면 회피')",
    "excites": "신나게 대답하는 주제 (예: '자기 좋아하는 드라마 얘기')"
  },
  "do_not": [
    "이 상대방이 절대 안 쓰는 스타일/표현 (예: '길게 설명 안 함', '이모지 남발 안 함', '\\"자기야\\" 같은 애칭 안 씀')"
  ],
  "current_feeling_toward_user": "현재 사용자에게 느끼는 감정 2~3문장 — 분석 결과의 심리/진단 반영. 구체적인 감정 상태(설렘/권태/짜증/조심스러움 등)와 그 이유.",
  "context_summary": "기존 대화의 핵심 맥락 3~4문장 — 현재 상황, 최근 다툼/이벤트, 썸/연애/권태 단계, 마지막 분위기"
}
